...
function update_shortcuts() {
  ...
  $( "#self_status_home" ).attr( "disabled", undefined == $.cookie( "slot__main__widget" ) ||
  ...
  $( "#self_shortcuts__prev" ).attr( "disabled", undefined == $.cookie( "slot__main__prev" ) )
                             .button( "refresh" );
  $( "#self_shortcuts__next" ).attr( "disabled", undefined == $.cookie( "slot__main__next" ) )
                             .button( "refresh" );
}
