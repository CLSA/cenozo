...
cenozo.directive( 'cnToolbelt', [
  'CnSession', 'CnHttpFactory', 'CnModalMessageFactory', 'CnModalTimezoneCalculatorFactory',
  function( CnSession, CnHttpFactory, CnModalMessageFactory, CnModalTimezoneCalculatorFactory ) {
    return {
      restrict: 'E',
