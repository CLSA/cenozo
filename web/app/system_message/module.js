cenozoApp.defineModule({
  ...
  create: (module) => {
    ...
    module.addInputGroup("", {
      application_id: {
        ...
        isExcluded: function ($state, model) {
          return model.hasAllSites() ? false : "add";
        },
        isConstant: function ($state, model) {
          return model.hasAllSites() ? false : "view";
        },
      ...
      site_id: {
        ...
        type: "enum",
        help:
          "Leaving the site blank will show the message across all sites.  If application is blank then this " +
          "will be ignored.",
        isExcluded: function ($state, model) {
          return model.hasAllSites() ? false : "add";
        },
    ...
    cenozo.providers.factory("CnSystemMessageModelFactory", [
      ...
      "CnSystemMessageAddFactory",
      "CnSystemMessageViewFactory",
      "CnSession",
      "CnHttpFactory",
      function (
        CnBaseModelFactory,
