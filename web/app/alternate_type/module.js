cenozoApp.defineModule({
  ...
  create: (module) => {
    ...
    cenozo.providers.factory("CnAlternateTypeModelFactory", [
      "CnBaseModelFactory",
      "CnAlternateTypeAddFactory",
      "CnAlternateTypeListFactory",
      "CnAlternateTypeViewFactory",
      "CnHttpFactory",
      function (
        CnBaseModelFactory,
        CnAlternateTypeAddFactory,
        ...
        var object = function (root) {
          ...
          this.getMetadata = async function () {
            ...
            response.data.forEach((item) => {
              this.metadata.columnList.alternate_consent_type_id.enumList.push({
                value: item.id,
                name: item.name,
              });
            });
