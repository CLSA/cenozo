      ...
      function (CnApplicationModelFactory, CnSession) {
        return {
          ...
          controller: function ($scope) {
            ...
            $scope.showChildren =
              $scope.model.getQueryParameter("identifier").split("=").pop() ==
              CnSession.application.name;
          },
        };
      },
    ]);
        ...
        var object = function (root) {
          ...
          this.showStudyPhase = function () {
            ...
            var show = // only show when viewing the right type of application
              ...
              ["beartooth", "cedar", "mastodon", "sabretooth"].includes(
                this.viewModel.record.application_type
              ) &&
            ...
            if (this.showStudyPhase()) {
              var response = await CnHttpFactory.instance({
                ...
                data: {
                  ...
                  modifier: {
                    order: { "study.name": false, "study_phase.rank": false },
                    limit: 1000,
                  },
                },
              }).query();
