        ...
        var object = function (parentModel, root) {
            ...
            updateAccess: async function () {
              ...
              const setAccess = (enable) => {
                ...
                if (angular.isDefined(this.participantModel))
                  this.participantModel.getChooseEnabled = enable
                    ? function () {
                        return true;
                      }
                    : function () {
                ...
                if (angular.isDefined(this.userModel))
                  this.userModel.getChooseEnabled = enable
                    ? function () {
                        return true;
                      }
                    : function () {
                ...
                if (angular.isDefined(this.applicationModel))
                  this.applicationModel.getChooseEnabled = enable
                    ? function () {
                        return true;
                      }
                    : function () {
          ...
          async function init(object) {
            ...
            if (angular.isDefined(object.userModel))
              object.userModel.listModel.heading = "User Control List";
