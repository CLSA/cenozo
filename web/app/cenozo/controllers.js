...
function CnBaseAddCtrl( $scope, singleton, createRecordFn ) {
  ...
  // define callbacks
  if( undefined !== $scope.local.cnList && undefined !== $scope.local.cnList.add ) {
...
function CnBaseListCtrl( $scope, $location, singleton, modalFactory ) {
  ...
  if( undefined !== $scope.local.cnList.orderBy ) {
    $scope.cbOrderBy = function( column ) {
      $scope.local.cnList.orderBy( column );
    };
  }
  
  if( undefined !== $scope.local.cnList.restrict ) {
...
function CnBaseViewCtrl( $scope, singleton ) {
  ...
  if( undefined !== $scope.local.cnList && undefined !== $scope.local.cnList.delete ) {
  ...
  if( undefined !== $scope.local.cnView.patch ) {
