...
namespace cenozo\service\form_association;
...
class module extends \cenozo\service\site_restricted_participant_module
{
  ...
  public function validate()
  {
    ...
    {
      $db_form_association = $this->get_resource();

      if( !is_null( $db_form_association ) )
      {
        $db_form = $db_form_association->get_form();
        ...
        {
          if( $db_form->get_participant()->get_effective_site()->id !=
            $db_restrict_site->id )
          {
  ...
  public function prepare_read( $select, $modifier )
  {
    ...
    $modifier->join( 'form', 'form_association.form_id', 'form.id' );
