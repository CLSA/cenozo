...
namespace cenozo\service\availability_type;
...
class module extends \cenozo\service\site_restricted_module
{
  ...
  public function prepare_read( $select, $modifier )
  {
    ...
    if( $select->has_column( 'participant_count' ) )
    {
      ...
      $inner_join_sel->add_column( 'availability_type_id' );
      $inner_join_sel->add_column( 'COUNT(*)', 'participant_count', false );

      $inner_join_mod = lib::create( 'database\modifier' );
      $inner_join_mod->group( 'availability_type_id' );
      $inner_join_mod->where( 'availability_type_id', '!=', NULL );
      ...
      $outer_join_sel->from( 'availability_type' );
      $outer_join_sel->add_column( 'id', 'availability_type_id' );
      $outer_join_sel->add_column(
        'IF( availability_type_id IS NOT NULL, participant_count, 0 )', 'participant_count', false );
