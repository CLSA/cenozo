...
namespace cenozo\service\alternate_consent;
...
class module extends \cenozo\service\site_restricted_participant_module
{
  ...
  public function validate()
  {
    ...
    if( 300 > $this->get_status()->get_code() )
    {
      ...
      $db_alternate_consent = $this->get_resource();
      if( !is_null( $db_alternate_consent ) )
      {
        $db_participant = $db_alternate_consent->get_alternate()->get_participant();
