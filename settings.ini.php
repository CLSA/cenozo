...
$settings['general']['cenozo_version'] = '2.0.0';
...
$SETTINGS['survey_db']['driver'] = 'mysql';
$SETTINGS['survey_db']['server'] = 'localhost';
$SETTINGS['survey_db']['username'] = 'limesurvey';
$SETTINGS['survey_db']['password'] = ''; 
$SETTINGS['survey_db']['database'] = 'localhost';
$SETTINGS['survey_db']['prefix'] = ''; 
