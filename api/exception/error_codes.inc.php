 ...
 * "runtime" error codes
 */
define( 'RUNTIME_AUTOLOADER__AUTOLOAD_ERROR_NUMBER',            RUNTIME_BASE_ERROR_NUMBER + 1 );
define( 'RUNTIME_BASE_REPORT__SET_PARAMETER_ERROR_NUMBER',      RUNTIME_BASE_ERROR_NUMBER + 2 );
define( 'RUNTIME_BASE_VIEW__SET_ITEM_ERROR_NUMBER',             RUNTIME_BASE_ERROR_NUMBER + 3 );
define( 'RUNTIME_CENOZO_MANAGER__SEND_ERROR_NUMBER',            RUNTIME_BASE_ERROR_NUMBER + 4 );
define( 'RUNTIME_DATABASE__GET_COLUMN_NAMES_ERROR_NUMBER',      RUNTIME_BASE_ERROR_NUMBER + 5 );
define( 'RUNTIME_DATABASE__GET_COLUMN_TYPE_ERROR_NUMBER',       RUNTIME_BASE_ERROR_NUMBER + 6 );
define( 'RUNTIME_DATABASE__GET_COLUMN_DATA_TYPE_ERROR_NUMBER',  RUNTIME_BASE_ERROR_NUMBER + 7 );
define( 'RUNTIME_DATABASE__GET_COLUMN_KEY_ERROR_NUMBER',        RUNTIME_BASE_ERROR_NUMBER + 8 );
define( 'RUNTIME_DATABASE__GET_COLUMN_DEFAULT_ERROR_NUMBER',    RUNTIME_BASE_ERROR_NUMBER + 9 );
define( 'RUNTIME_DATABASE__GET_UNIQUE_KEYS_ERROR_NUMBER',       RUNTIME_BASE_ERROR_NUMBER + 10 );
define( 'RUNTIME_DATABASE__CONNECT_ERROR_NUMBER',               RUNTIME_BASE_ERROR_NUMBER + 11 );
define( 'RUNTIME_FACTORY__SELF_ERROR_NUMBER',                   RUNTIME_BASE_ERROR_NUMBER + 12 );
define( 'RUNTIME_FACTORY__EXISTS_ERROR_NUMBER',                 RUNTIME_BASE_ERROR_NUMBER + 13 );
define( 'RUNTIME_INDEX__SCRIPT_ERROR_NUMBER',                   RUNTIME_BASE_ERROR_NUMBER + 14 );
define( 'RUNTIME_LDAP_MANAGER__VALIDATE_USER_ERROR_NUMBER',     RUNTIME_BASE_ERROR_NUMBER + 15 );
define( 'RUNTIME_LDAP_MANAGER__SET_USER_PASSWORD_ERROR_NUMBER', RUNTIME_BASE_ERROR_NUMBER + 16 );
define( 'RUNTIME_LOG__INITIALIZE_LOGGER_ERROR_NUMBER',          RUNTIME_BASE_ERROR_NUMBER + 17 );
define( 'RUNTIME_NOTE_LIST__FINISH_ERROR_NUMBER',               RUNTIME_BASE_ERROR_NUMBER + 18 );
define( 'RUNTIME_NOTE_NEW__FINISH_ERROR_NUMBER',                RUNTIME_BASE_ERROR_NUMBER + 19 );
define( 'RUNTIME_OPERATION____CONSTRUCT_ERROR_NUMBER',          RUNTIME_BASE_ERROR_NUMBER + 20 );
define( 'RUNTIME_PULL__SCRIPT_ERROR_NUMBER',                    RUNTIME_BASE_ERROR_NUMBER + 21 );
define( 'RUNTIME_PUSH__SCRIPT_ERROR_NUMBER',                    RUNTIME_BASE_ERROR_NUMBER + 22 );
define( 'RUNTIME_RECORD____CONSTRUCT_ERROR_NUMBER',             RUNTIME_BASE_ERROR_NUMBER + 23 );
define( 'RUNTIME_RECORD__LOAD_ERROR_NUMBER',                    RUNTIME_BASE_ERROR_NUMBER + 24 );
define( 'RUNTIME_RECORD__SAVE_ERROR_NUMBER',                    RUNTIME_BASE_ERROR_NUMBER + 25 );
define( 'RUNTIME_RECORD____CALL_ERROR_NUMBER',                  RUNTIME_BASE_ERROR_NUMBER + 26 );
define( 'RUNTIME_REPORT____CALL_ERROR_NUMBER',                  RUNTIME_BASE_ERROR_NUMBER + 27 );
define( 'RUNTIME_REPORT__SET_CELL_ERROR_NUMBER',                RUNTIME_BASE_ERROR_NUMBER + 28 );
define( 'RUNTIME_REPORT__MERGE_CELLS_ERROR_NUMBER',             RUNTIME_BASE_ERROR_NUMBER + 29 );
define( 'RUNTIME_SELF_SET_SITE__FINISH_ERROR_NUMBER',           RUNTIME_BASE_ERROR_NUMBER + 30 );
define( 'RUNTIME_UTIL__AUTOLOAD_ERROR_NUMBER',                  RUNTIME_BASE_ERROR_NUMBER + 31 );
