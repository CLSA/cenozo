...
define( 'ARGUMENT__CENOZO_UI_WIDGET_BASE_PARTICIPANT_MULTI__SET_PARAMETER__ERRNO',
 ...
 * "notice" error codes
 */
define( 'NOTICE__CENOZO_APPLICATION__EXECUTE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 1 );
define( 'NOTICE__CENOZO_APPLICATION__CREATE_OPERATION__ERRNO',
...
define( 'NOTICE__CENOZO_UI_PULL_BASE_PARTICIPANT_MULTI__VALIDATE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 13 );
define( 'NOTICE__CENOZO_UI_PULL_BASE_REPORT__GENERATE__ERRNO',
...
define( 'NOTICE__CENOZO_UI_PUSH_APPLICATION_EDIT__VALIDATE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 17 );
define( 'NOTICE__CENOZO_UI_PUSH_APPLICATION_NEW__VALIDATE__ERRNO',
...
define( 'NOTICE__CENOZO_UI_PUSH_BASE_PARTICIPANT_MULTI__VALIDATE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 24 );
define( 'NOTICE__CENOZO_UI_PUSH_COHORT_NEW__VALIDATE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 25 );
define( 'NOTICE__CENOZO_UI_PUSH_COLLECTION_EDIT__VALIDATE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 26 );
define( 'NOTICE__CENOZO_UI_PUSH_COLLECTION_NEW__VALIDATE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 27 );
define( 'NOTICE__CENOZO_UI_PUSH_CONSENT_NEW__VALIDATE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 28 );
define( 'NOTICE__CENOZO_UI_PUSH_JURISDICTION_EDIT__VALIDATE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 29 );
define( 'NOTICE__CENOZO_UI_PUSH_JURISDICTION_NEW__VALIDATE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 30 );
define( 'NOTICE__CENOZO_UI_PUSH_LANGUAGE_EDIT__VALIDATE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 31 );
define( 'NOTICE__CENOZO_UI_PUSH_PARTICIPANT_DELETE_ALTERNATE__FINISH__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 32 );
define( 'NOTICE__CENOZO_UI_PUSH_PARTICIPANT_DELINK__VALIDATE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 33 );
define( 'NOTICE__CENOZO_UI_PUSH_PARTICIPANT_DELINK__EXECUTE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 34 );
define( 'NOTICE__CENOZO_UI_PUSH_PARTICIPANT_EDIT__VALIDATE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 35 );
define( 'NOTICE__CENOZO_UI_PUSH_PARTICIPANT_MULTIEDIT__EXECUTE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 36 );
define( 'NOTICE__CENOZO_UI_PUSH_PARTICIPANT_NEW__VALIDATE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 37 );
define( 'NOTICE__CENOZO_UI_PUSH_PARTICIPANT_SITE_REASSIGN__EXECUTE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 38 );
define( 'NOTICE__CENOZO_UI_PUSH_PHONE_EDIT__VALIDATE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 39 );
define( 'NOTICE__CENOZO_UI_PUSH_PHONE_NEW__VALIDATE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 40 );
define( 'NOTICE__CENOZO_UI_PUSH_QUOTA_NEW__VALIDATE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 41 );
define( 'NOTICE__CENOZO_UI_PUSH_SELF_SET_PASSWORD__VALIDATE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 42 );
define( 'NOTICE__CENOZO_UI_PUSH_SELF_TEMPORARY_FILE__VALIDATE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 43 );
define( 'NOTICE__CENOZO_UI_PUSH_SELF_TEMPORARY_FILE__EXECUTE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 44 );
define( 'NOTICE__CENOZO_UI_PUSH_SITE_EDIT__VALIDATE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 45 );
define( 'NOTICE__CENOZO_UI_PUSH_SITE_NEW__VALIDATE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 46 );
define( 'NOTICE__CENOZO_UI_PUSH_SOURCE_NEW__VALIDATE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 47 );
define( 'NOTICE__CENOZO_UI_PUSH_STATE_NEW__VALIDATE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 48 );
define( 'NOTICE__CENOZO_UI_PUSH_SYSTEM_MESSAGE_DELETE__VALIDATE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 49 );
define( 'NOTICE__CENOZO_UI_PUSH_SYSTEM_MESSAGE_EDIT__VALIDATE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 50 );
define( 'NOTICE__CENOZO_UI_PUSH_SYSTEM_MESSAGE_NEW__VALIDATE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 51 );
define( 'NOTICE__CENOZO_UI_PUSH_USER_DELETE__VALIDATE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 52 );
define( 'NOTICE__CENOZO_UI_PUSH_USER_DELETE_ACCESS__VALIDATE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 53 );
define( 'NOTICE__CENOZO_UI_PUSH_USER_NEW__VALIDATE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 54 );
define( 'NOTICE__CENOZO_UI_PUSH_USER_NEW_ACCESS__VALIDATE__ERRNO',
        NOTICE_CENOZO_BASE_ERRNO + 55 );
...
define( 'PERMISSION__CENOZO_UI_PULL_SELF_SEMAPHORE_COUNT__VALIDATE__ERRNO',
        PERMISSION_CENOZO_BASE_ERRNO + 6 );

/**
 * "runtime" error codes
 */
define( 'RUNTIME__CENOZO_APPLICATION__CREATE_OPERATION__ERRNO',
...
define( 'RUNTIME__CENOZO_SERVICE_SERVICE__PREPARE__ERRNO',
...
define( 'RUNTIME__CENOZO_UI_PULL_SELF_SEMAPHORE_COUNT__VALIDATE__ERRNO',
...
define( 'RUNTIME__CENOZO_UI_WIDGET_BASE_PARTICIPANT_MULTI__SET_PARAMETER__ERRNO',
...
define( 'RUNTIME__CENOZO_UI_WIDGET_PARTICIPANT_SEARCH__PREPARE__ERRNO',
