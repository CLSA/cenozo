...
class region_site_add extends base_view
{
  ...
  protected function prepare()
  {
    ...
    $this->add_item( 'application_id', 'hidden' );
  ...
  protected function setup()
  {
    ...
    $db_application = is_null( $this->parent )
    ...
    $site_mod->where( 'application_id', '=', $db_application->id );
    $site_mod->order( 'name' );
    ...
    $this->set_item( 'application_id', $db_application->id );
    $this->set_item( 'region_id', key( $regions ), true, $regions );
    $this->set_item( 'language_id', $db_application->language_id, true, $languages );
