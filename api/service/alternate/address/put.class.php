...
namespace cenozo\service\alternate\address;
use cenozo\lib, cenozo\log;

/**
 * Custom class for put requests
 */
class put extends \cenozo\service\put
{
  /**
   * TODO: document
   */
  protected function get_resource( $index )
  {
    ...
    // "person_id" into the key instead of the default "alternate_id"
    if( 0 < $index &&
