    ...
    super({
      ...
      properties: {
        application_id: {
          ...
          is_hidden: (model) => CN_session.data.role.all_sites ? false : "add" == model.get_action_name(),
          is_constant: (model) => CN_session.data.role.all_sites ? false : "view" == model.get_action_name(),
        },
        site_id: {
          title: "Site",
          type: "enum",
