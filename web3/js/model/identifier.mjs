...
export class CN_model_identifier extends CN_model_base {
  constructor() {
    super({
      wording: {
        singular: "identifier",
...
export class CN_view_identifier extends CN_action_view {
  /**
...
export class CN_upload_identifier extends CN_action_upload {
  /**
