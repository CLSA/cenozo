SELECT "Creating new update_alternate_last_written_alternate_consents procedure" AS "";

DROP PROCEDURE IF EXISTS update_alternate_last_written_alternate_consents;
