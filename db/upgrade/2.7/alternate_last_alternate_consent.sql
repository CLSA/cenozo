DROP PROCEDURE IF EXISTS patch_alternate_last_alternate_consent;
DELIMITER //
CREATE PROCEDURE patch_alternate_last_alternate_consent()
  BEGIN
...
CALL patch_alternate_last_alternate_consent();
DROP PROCEDURE IF EXISTS patch_alternate_last_alternate_consent;
