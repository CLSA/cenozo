...
-- Tue 11 Oct 2016 02:03:15 PM EDT
...
-- -----------------------------------------------------
-- Table `application`.`export`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `application`.`export` ;

CREATE TABLE IF NOT EXISTS `application`.`export` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `title` VARCHAR(255) NOT NULL,
...
-- -----------------------------------------------------
-- Table `application`.`export_column`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `application`.`export_column` ;

CREATE TABLE IF NOT EXISTS `application`.`export_column` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  ...
  CONSTRAINT `fk_export_column_export_id`
    ...
    REFERENCES `application`.`export` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `application`.`export_restriction`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `application`.`export_restriction` ;

CREATE TABLE IF NOT EXISTS `application`.`export_restriction` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `export_id` INT UNSIGNED NOT NULL,
  ...
  CONSTRAINT `fk_export_restriction_export_column_id`
    ...
    REFERENCES `application`.`export_column` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
