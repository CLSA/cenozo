...
-- Fri 27 May 2016 04:46:01 PM EDT
...
-- -----------------------------------------------------
-- Table `cenozo`.`report_schedule_has_report_type_restriction`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenozo`.`report_schedule_has_report_type_restriction` ;

CREATE TABLE IF NOT EXISTS `cenozo`.`report_schedule_has_report_type_restriction` (
