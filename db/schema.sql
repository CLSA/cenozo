...
-- -----------------------------------------------------
-- Table `cenozo`.`activity_archive`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cenozo`.`activity_archive` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` INT(10) UNSIGNED NOT NULL,
  `application_id` INT(10) UNSIGNED NOT NULL,
  `site_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cenozo`.`user_ip_address`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cenozo`.`user_ip_address` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `user_id` INT(10) UNSIGNED NOT NULL,
...
-- Table `app`.`access`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `app`.`access` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `user_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `app`.`custom_report`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `app`.`custom_report` (
...
-- -----------------------------------------------------
-- Table `app`.`role_has_custom_report`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `app`.`role_has_custom_report` (
  `role_id` INT(10) UNSIGNED NOT NULL,
  ...
  CONSTRAINT `fk_role_has_custom_report_custom_report_id`
    ...
    REFERENCES `app`.`custom_report` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `app`.`role_has_service`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `app`.`role_has_service` (
  `role_id` INT(10) UNSIGNED NOT NULL,
...
-- Table `app`.`writelog`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `app`.`writelog` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` INT(10) UNSIGNED NOT NULL,
  `site_id` INT(10) UNSIGNED NOT NULL,
  `role_id` INT(10) UNSIGNED NOT NULL,
...
USE `cenozo`$$
CREATE DEFINER = CURRENT_USER TRIGGER `cenozo`.`alternate_AFTER_DELETE` AFTER DELETE ON `alternate` FOR EACH ROW
BEGIN
