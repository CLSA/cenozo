...
-- Fri 08 Dec 2017 04:00:27 PM EST
...
CREATE TABLE IF NOT EXISTS `cenozo`.`participant` (
  ...
  INDEX `fk_enrollment_id` (`enrollment_id` ASC),
  ...
  CONSTRAINT `fk_participant_availability_type_id`
    ...
    ON DELETE SET NULL
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_participant_enrollment_id`
    FOREIGN KEY (`enrollment_id`)
    REFERENCES `cenozo`.`enrollment` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
BEGIN
  IF proc_participant_id IS NOT NULL THEN
    ...
    IF 0 = @address_count OR 0 = @phone_count THEN
      IF "trace" != IFNULL( @trace_type, "" ) THEN
...
-- -----------------------------------------------------
-- procedure remove_duplicate_proxy
-- -----------------------------------------------------

USE `cenozo`;
DROP procedure IF EXISTS `cenozo`.`remove_duplicate_proxy`;
...
-- -----------------------------------------------------
-- procedure remove_duplicate_trace
-- -----------------------------------------------------

USE `cenozo`;
DROP procedure IF EXISTS `cenozo`.`remove_duplicate_trace`;
