...
-- collection
INSERT INTO operation( type, subject, name, restricted, description )
VALUES( "widget", "collection", "add", true, "View a form for creating a new collection." );
INSERT INTO operation( type, subject, name, restricted, description )
VALUES( "widget", "collection", "add_participant", true, "A form to add a participant to a collection." );
INSERT INTO operation( type, subject, name, restricted, description )
VALUES( "widget", "collection", "add_user", true, "A form to add a user to a collection." );
INSERT INTO operation( type, subject, name, restricted, description )
VALUES( "push", "collection", "delete", true, "Removes a collection from the system." );
INSERT INTO operation( type, subject, name, restricted, description )
VALUES( "push", "collection", "delete_participant", true, "Remove a collection's participant." );
INSERT INTO operation( type, subject, name, restricted, description )
VALUES( "push", "collection", "delete_user", true, "Remove a collection's user." );
INSERT INTO operation( type, subject, name, restricted, description )
VALUES( "push", "collection", "edit", true, "Edits a collection's details." );
INSERT INTO operation( type, subject, name, restricted, description )
VALUES( "widget", "collection", "list", true, "List collections in the system." );
INSERT INTO operation( type, subject, name, restricted, description )
VALUES( "push", "collection", "new", true, "Add a new collection to the system." );
INSERT INTO operation( type, subject, name, restricted, description )
VALUES( "push", "collection", "new_participant", true, "Add a participant to a collection." );
INSERT INTO operation( type, subject, name, restricted, description )
VALUES( "push", "collection", "new_user", true, "Add a user to a collection." );
INSERT INTO operation( type, subject, name, restricted, description )
VALUES( "widget", "collection", "view", true, "View a collection's details." );

-- jurisdiction
INSERT INTO operation( type, subject, name, restricted, description )
VALUES( "widget", "jurisdiction", "add", true, "View a form for creating new association between postcodes and sites." );
INSERT INTO operation( type, subject, name, restricted, description )
VALUES( "push", "jurisdiction", "delete", true, "Removes an association between a postcode and a site from the system." );
INSERT INTO operation( type, subject, name, restricted, description )
VALUES( "push", "jurisdiction", "edit", true, "Edits an association between a postcode and a site." );
INSERT INTO operation( type, subject, name, restricted, description )
VALUES( "widget", "jurisdiction", "list", true, "List associations between postcodes and sites in the system." );
INSERT INTO operation( type, subject, name, restricted, description )
VALUES( "push", "jurisdiction", "new", true, "Add a new association between a postcode and a site to the system." );
INSERT INTO operation( type, subject, name, restricted, description )
